...
// Yearly-plan checkout is the same $40 Stripe link the rest of the site
// uses. AI Bundle buyers land on /checkout?plan=yearly, get the same
// gateway options (Stripe / PayPal / Barq / InstaPay / Vodafone Cash),
// and unlock the full catalog — so 'AI Bundle' is a marketing framing
// around the yearly plan for the AI-curious audience.
...
export default async function AIBundlePage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-white">
      ...
      {/* ═════════════════════════  HERO  ═════════════════════════ */}
      <section className="relative px-4 pt-10 sm:pt-16 pb-14 sm:pb-20">
        <div
          aria-hidden
        ...
        <div className="relative container mx-auto max-w-4xl text-center">
          ...
          <p className="max-w-2xl mx-auto text-sm sm:text-lg text-gray-600 mb-6 leading-relaxed">
          ...
          {/* Price + CTA card — same visual weight as /personal-plan */}
          <div className="mx-auto max-w-md rounded-2xl border border-brand-500/30 bg-white shadow-sm px-4 py-5 sm:px-5 sm:py-6 mb-4">
            <div className="text-sm text-gray-600 mb-3">
              ...
              <span className="block text-[11px] text-gray-400 mt-1">
                خصم {p.savingsPct}% لفترة محدودة · ضمان استرداد ٧ أيام
              </span>
            </div>
            ...
            <Button asChild size="lg" className="w-full font-bold min-h-[52px] text-base">
              <Link href={CHECKOUT_HREF}>
                ...
                خد الـ Bundle بـ ${p.yearlyAmount} دلوقتي
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            ...
            <PathCard
              ...
              month="الشهر ٢"
              title="فيديو AI"
              outcome="محتوى قابل للبيع أو الاستخدام"
              accent="emerald"
            />
            <PathCard
              icon={Code}
              month="الشهر ٣"
              title="Vibe Coding"
              outcome="تطبيق SaaS كأصل رقمي"
              accent="indigo"
            />
          </div>

          {/* Real testimonial next to CTA */}
            ...
            <table className="w-full text-sm bg-white rounded-2xl border border-gray-200 overflow-hidden">
              <thead className="bg-brand-500 text-white">
                <tr>
                  ...
                  <th className="text-center px-3 sm:px-4 py-3 font-bold bg-brand-600">
                    AI Bundle
                  </th>
                  <th className="text-center px-3 sm:px-4 py-3 font-medium opacity-80">
                    كورسات إنجليزي
                  </th>
                  <th className="text-center px-3 sm:px-4 py-3 font-medium opacity-80">
                    مدرّب خاص
              ...
              <tbody className="text-xs sm:text-sm">
                <CompareRow
                  feature="السعر"
                  bundle={`$${p.yearlyAmount}`}
                  a="$500-2000"
                  b="$3000+"
                  c="مجاني (بضريبة الوقت)"
                />
                <CompareRow
                  feature="اللغة"
                  bundle="✅ عربي كامل"
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-xl mx-auto">
              ٣ كورسات كاملة — كل كورس بيديك مهارة تكسب بيها من أول أسبوع.
            </p>
          </div>
          ...
          <div className="text-center mt-10">
            <Button asChild size="lg" className="font-bold">
              <Link href={CHECKOUT_HREF}>
                خد الـ ٣ كورسات بـ ${p.yearlyAmount}
                <ArrowLeft className="w-4 h-4" />
              </Link>
            </Button>
          </div>
      ...
      <section className="px-4 py-16 sm:py-24 bg-gradient-to-br from-amber-50 via-white to-brand-500/5 border-y border-amber-200">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <BonusCard
              icon={Video}
              title="+5,000 فيديو AI جاهز"
              desc="مكتبة PLR/MRR تستخدمها في مشاريعك أو تعيد بيعها."
              value={244}
            />
            <BonusCard
              icon={Package}
              title="15,000 سكربت أتمتة n8n"
              desc="قوالب جاهزة لكل صناعة — بس ابدأ استخدامها."
              value={50}
            />
            <BonusCard
              icon={Server}
              title="سيرفر n8n مجاني — سنة كاملة"
              desc="مش محتاج تدفع hosting — السيرفر عندنا."
              value={30}
            />
            <BonusCard
              icon={MessageCircle}
              title="مجتمع WhatsApp + دعم مباشر"
              desc="اسأل أي سؤال، رد خلال ساعات، مش يومين."
              value={30}
            />
            <BonusCard
              icon={RefreshCw}
              title="تحديثات مجانية — سنة كاملة"
              desc="كل كورس جديد أو تحديث بيوصلك مجاناً."
              value={40}
              wide
            />
          </div>
      ...
      <section className="px-4 py-16 sm:py-24">
        <div className="container mx-auto max-w-2xl">
          <div className="text-center mb-8">
            <h2 className="font-display text-2xl sm:text-4xl font-extrabold mb-2">
              الحسبة كاملة
            </h2>
          ...
          <div className="mt-6 text-center">
            <Button asChild size="lg" className="font-bold w-full sm:w-auto min-h-[56px]">
              <Link href={CHECKOUT_HREF}>
                <Gift className="w-5 h-5" />
                خد كل ده بـ ${p.yearlyAmount} دلوقتي
                <ArrowLeft className="w-4 h-4" />
              </Link>
            </Button>
      ...
      <section className="px-4 py-16 sm:py-24 bg-gray-50 border-y border-gray-200">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-10">
            <h2 className="font-display text-3xl sm:text-5xl font-extrabold mb-3">
              +1,000 طالب بدأوا رحلتهم
            </h2>
            <p className="text-gray-600 max-w-xl mx-auto">
              دي حقيقة أرقام حصلت لناس زيّك بالظبط.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <Testimonial
              ...
              name="أحمد خالد"
              city="القاهرة"
              quote="بديت بـ n8n، بعدين AI Video. دلوقتي عندي ٣ عملاء ثابتين بيدفعوا شهرياً."
            />
            <Testimonial
              tag="AI Video"
              name="سارة المنصور"
              city="الرياض"
              quote="أول فيديو AI عمله وصل مليون مشاهدة. البراند بتاعي كبر ٣ أضعاف في شهرين."
            />
            <Testimonial
              tag="Vibe Coding"
              name="محمد العمري"
              city="الكويت"
              quote="طلعت أول SaaS بتاعي في ٦ أسابيع. دلوقتي بيجيبلي $800/شهر."
            />
            <Testimonial
              tag="Bundle"
              name="لينا حسن"
              city="بيروت"
              quote="دخلي زاد ٣ أضعاف في ٤ شهور. الـ ٣ كورسات مكمّلين بعض."
            />
            <Testimonial
              tag="n8n"
              name="عمر الرشيد"
              city="دبي"
              quote="كنت باخد ساعتين على كل مهمة روتينية. دلوقتي ١٥ دقيقة."
            />
            <Testimonial
              tag="AI Video"
              name="نور الدين بوعزيز"
              city="تونس"
              quote="بعت ٥ فيديوهات لعميل بسعر $2000. عيالي بيبيعوا محتوى AI دلوقتي."
            />
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-2xl">
          ...
          <div className="space-y-3">
            <FaqItem
              ...
              a="أيوه، الـ ٣ كورسات مصممين من الصفر. الدرس الأول في كل كورس بيفترض إنك لسه ما استخدمتش أي أداة قبل كده."
            />
            <FaqItem
              q="لو مش عاجبني، هرجّع فلوسي إزاي؟"
              a="كلّمنا على واتساب خلال ٧ أيام من تاريخ الشراء، ابعت رقم الطلب، وهنرجّعلك المبلغ كامل خلال ٤٨ ساعة."
            />
            <FaqItem
              q="الوصول امتى؟"
              a="فوري بعد الدفع. الإيميل والوصول للـ ٣ كورسات بيوصلك في نفس اللحظة."
            />
          </div>
        </div>
      </section>
      ...
      <section className="px-4 py-16 sm:py-24 bg-gradient-to-br from-brand-500 via-brand-600 to-emerald-700 text-white text-center">
        <div className="container mx-auto max-w-3xl">
          <h2 className="font-display text-3xl sm:text-5xl font-extrabold mb-4 leading-tight">
            ٣ مصادر دخل. ٩٠ يوم.{' '}
            <span dir="ltr">${p.yearlyAmount}</span> فقط.
          </h2>
          ...
          <Button asChild size="lg" className="bg-white text-brand-700 hover:bg-gray-100 font-bold min-h-[60px] text-base sm:text-lg w-full sm:w-auto">
            <Link href={CHECKOUT_HREF}>
              <Gift className="w-5 h-5" />
              اشترك في الـ Bundle بـ ${p.yearlyAmount}
          ...
          <div className="mt-8 p-5 rounded-xl bg-white/10 backdrop-blur border border-white/20 max-w-md mx-auto">
            ...
            <p className="text-sm italic opacity-95 mb-2">
              "دخلي زاد ٣ أضعاف في ٤ شهور."
            </p>
      ...
      <section className="px-4 py-16 sm:py-24">
        <div className="container mx-auto max-w-2xl">
          <h2 className="font-display text-3xl sm:text-4xl font-extrabold text-center mb-8">
            أسئلة شائعة
          </h2>
          <div className="space-y-3">
            <FaqItem
              q="الكورسات مناسبة للمبتدئين؟"
              a="أيوه — كل كورس من الـ ٣ بيبدأ من الصفر. لو مبتدئ في الأدوات دي، مش هتحتاج أي خلفية تقنية سابقة."
            />
            <FaqItem
              q="امتى هاخد الوصول؟"
              a="فوراً بعد الدفع. بتوصلك رسالة تأكيد فيها بيانات الدخول لكل الكورسات."
            />
            <FaqItem
              q="سياسة الاسترداد؟"
              a="ضمان استرداد كامل خلال ٧ أيام من الشراء — بدون أسئلة. كلّمنا على واتساب وارجعلك فلوسك."
            />
            <FaqItem
              q="الكورسات محدثة لـ 2026؟"
              a="أيوه. الأدوات (n8n, Runway, Kling, Cursor, إلخ) بتتحدث كل شوية، وإحنا بنحدث الكورسات باستمرار. التحديثات كلها مجاناً لسنة كاملة."
            />
            <FaqItem
              q="طرق الدفع المتاحة؟"
              a="بطاقات فيزا وماستركارد (عبر Stripe) و PayPal. للعملاء في مصر: InstaPay أو Vodafone Cash. للعملاء في السعودية: Barq."
            />
            <FaqItem
              q="الدعم الفني بعد الشراء؟"
              a="مجتمع WhatsApp خاص فيه المدرّبين + الطلاب. ترد على أي سؤال خلال ساعات، مش يومين."
            />
            <FaqItem
              q="أقدر أشتري كورس واحد بس؟"
              a="أيوه — الكورسات متاحة فرادى بسعر $40 لكل كورس. بس الـ Bundle بيديك الـ ٣ + البونصات ($394 قيمة إضافية) بنفس السعر — عرض أفضل بمراحل."
            />
          </div>
        </div>
      </section>
...
function PathCard({
  ...
  return (
    <div className={`rounded-2xl bg-white border-2 ${colors.split(' ')[2]} overflow-hidden shadow-sm`}>
      <div className={`bg-gradient-to-br ${colors.split(' ').slice(0, 2).join(' ')} text-white p-5 text-center`}>
...
function CompareRow({
  ...
  return (
    <tr className="border-t border-gray-100">
      ...
      <td className="px-3 sm:px-4 py-3 text-center bg-brand-500/5 font-bold text-brand-700">
        {bundle}
      </td>
...
function CourseCard({
  ...
  return (
    <div className="rounded-2xl bg-white border border-gray-200 p-6 hover:border-brand-500/40 hover:shadow-md transition-all">
      ...
      <div className="flex items-center justify-between text-sm pt-3 border-t border-gray-100">
        <span className="text-gray-500 line-through" dir="ltr">
          ${price}
        </span>
        <span className="font-bold text-emerald-600">مجاناً في الـ Bundle ✅</span>
      </div>
    </div>
  );
}
...
function BonusCard({
  ...
  return (
    <div
      className={`rounded-2xl bg-white border border-amber-200 p-5 hover:border-amber-400 transition-colors ${
        wide ? 'sm:col-span-2' : ''
      }`}
    >
...
function ValueRow({ icon, text, value }: { icon: string; text: string; value: number }) {
  return (
    <div className="flex items-center justify-between py-2 text-sm">
      ...
      <span dir="ltr" className="font-bold text-gray-800 flex-shrink-0">
        ${value}
      </span>
    </div>
  );
