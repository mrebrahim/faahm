...
export const metadata: Metadata = {
  ...
  description: 'فاهم — أول منصة عربية متخصصة في كورسات الذكاء الاصطناعي، الأتمتة، والتسويق الرقمي. تعلّم AI و n8n وأدوات الذكاء الاصطناعي من خبراء عرب باشتراك واحد بسيط.',
  keywords: [
    'الذكاء الاصطناعي',
    'كورسات AI',
    'كورسات عربية',
