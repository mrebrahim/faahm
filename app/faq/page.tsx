    ...
    items: [
      {
        ...
        a: (
          <>
            سجّل حساب مجاني من{' '}
            <Link href={ROUTES.signup} className="text-brand-600 underline hover:no-underline">
              صفحة التسجيل
            </Link>
            ، اشترك من{' '}
      ...
      },
      {
        ...
        a: 'آه فيه فرق كبير. الشهري بـ $9.99 وفيه الكورسات بس. السنوي بـ $40 (يعني $3.3/شهر — وفّر 67%) وفيه كل حاجة: الكورسات + المساعد الذكي فاهم + شهادة الإتمام + أولوية الدعم الفني.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        q: 'الأسعار بالدولار ولا بالجنيه؟',
        a: 'الأسعار بالدولار الأمريكي ($9.99 شهرياً / $40 سنوياً). البنك بتاعك بيحوّل تلقائياً للعملة المحلية بسعر اليوم.',
      },
      {
