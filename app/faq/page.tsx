...
const FAQS: Array<{ section: string; items: Array<{ q: string; a: React.ReactNode }> }> = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'نفس المحتوى بالظبط. الاشتراك السنوي بيوفّرلك 33% (شهرين مجاناً) + أولوية في الدعم + وصول مبكر للكورسات الجديدة.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'الأسعار بالدولار الأمريكي ($5 شهرياً / $40 سنوياً). البنك بتاعك بيحوّل تلقائياً للعملة المحلية بسعر اليوم.',
      },
      {
