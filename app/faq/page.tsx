...
const FAQS: Array<{ section: string; items: Array<{ q: string; a: React.ReactNode }> }> = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'آه فيه فرق كبير. الشهري بـ 39 ر.س وفيه الكورسات بس. السنوي بـ 149 ر.س (يعني ~12 ر.س/شهر — وفّر 67%) وفيه كل حاجة: الكورسات + المساعد الذكي فاهم + شهادة الإتمام + أولوية الدعم الفني.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        q: 'الأسعار بأي عملة؟',
        a: 'الأسعار الأساسية بالريال السعودي (39 ر.س شهرياً / 149 ر.س سنوياً). للعملاء في مصر، فيه طرق دفع محلية بالجنيه (500 ج.م شهري / 2000 ج.م سنوي) عبر InstaPay أو Vodafone Cash.',
      },
      {
