...
const FAQS: Array<{ section: string; items: Array<{ q: string; a: React.ReactNode }> }> = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'آه فيه فرق كبير. الشهري بـ $10 وفيه الكورسات بس. السنوي بـ $40 (يعني ~$3.33/شهر — وفّر 67%) وفيه كل حاجة: الكورسات + المساعد الذكي فاهم + شهادة الإتمام + أولوية الدعم الفني.',
      },
    ],
  },
  {
